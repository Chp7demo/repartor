...
QT_MOC_LITERAL(9, 9), // "record_ag"
QT_MOC_LITERAL(19, 0), // ""
QT_MOC_LITERAL(20, 11), // "vector<int>"
QT_MOC_LITERAL(32, 6), // "fin_ag"
QT_MOC_LITERAL(39, 9), // "aff_graph"
QT_MOC_LITERAL(49, 3) // "run"

    },
    "MyThread\0record_ag\0\0vector<int>\0fin_ag\0"
    "aff_graph\0run"
};
...
static const uint qt_meta_data_MyThread[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       5,    0,   50,    2, 0x06,    8 /* Public */,

 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       6,    0,   51,    2, 0x0a,    9 /* Public */,
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MyThread::*)(double , double , int , vector<int> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::record_ag)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyThread::*)(vector<int> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::fin_ag)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::aff_graph)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::record_ag(double _t1, double _t2, int _t3, vector<int> _t4)
{
...
// SIGNAL 1
void MyThread::fin_ag(vector<int> _t1)
{
