...
//bug à regler: interactions de type couple :on peut mettre en cpl (visuellement) un elem qui l'est déja...
...
void MaGraphicsViewI::aff_cercle(Elements scl)
{
    ...
    for(unsigned int i=0;i<scl.elem_names.size();i++)
