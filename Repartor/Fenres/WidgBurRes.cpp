...
WidgBurRes::WidgBurRes(QRectF rect,QGraphicsItem *parent) :QGraphicsObject(parent)
{
...
QRectF WidgBurRes::boundingRect() const
{
return rect_ini;
}

 void WidgBurRes::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
/*
if(cpl_actif)
{
...
//update();
 ...
 void WidgBurRes::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
}
void WidgBurRes::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
}

 void WidgBurRes::hoverEnterEvent(QGraphicsSceneHoverEvent *event)
{
}

 void WidgBurRes::hoverLeaveEvent(QGraphicsSceneHoverEvent *event) 
{
}

void WidgBurRes::paint(QPainter *painter,const QStyleOptionGraphicsItem *option,QWidget *widget)
{
Q_UNUSED(option);
Q_UNUSED(widget);
//===========contour=============================
...
//=======================================================
//=================== N_text====================
//TODO peindre de l'exterieur si jeveux que le text depasse....
/*
//QPointF pt_N=get_centre();
QRectF rect=rect_ini;//pas terrible ça...

        rect.adjust(-10*rect_ini.x(),-10*rect_ini.y(),10*rect_ini.x(),10*rect_ini.y());//pas beau...
painter->drawText(rect,Qt::AlignCenter,N_text);
*/
//=======================================================
...
void WidgBurRes::dragEnterEvent(QGraphicsSceneDragDropEvent * event)
{//TODO verif format
event->accept();
}

void WidgBurRes::dropEvent(QGraphicsSceneDragDropEvent * event)
{/*
//TODO verif format
...
this->set_text(text_received);//useless?
//cout<<text_received.toStdString()<<endl;
//-----------------------widg interne--------------------
QRectF rect(this->get_centre().x(),this->get_centre().y(),150,20);//dimensions calquees sur widgNres
rect.translate(-rect.width()/2,-rect.height()/2);
widgNRG *wn=new widgNRG(rect);
wn->setN(text_received);
wn->setParent(this);//utile?
this->scene()->addItem(wn);
//update();
//wn->show();
//----------------------------------------------------------------
*/
...
void WidgBurRes::dragMoveEvent(QGraphicsSceneDragDropEvent *event)
{
//TODO verif format
event->accept();
}
  ...
  void WidgBurRes::set_couleur(const QColor & coul)
{
couleur=coul;
update();
}
...
QPainterPath WidgBurRes::shape() const
{
return painting_path;
}


 void WidgBurRes::rotation()
{
...
rotation(pi/18);
 ...
 void WidgBurRes::rotation(double ang_rad)
{
...
void WidgBurRes::set_shape(QPainterPath path_shape,QPolygonF poly_shape)
{
...
polygon_shape=poly_shape;
 ...
 QPolygonF WidgBurRes::get_polygon() 
{
return polygon_shape;
}

QPainterPath WidgBurRes::rotated_shape()
{
...
//update();
  ...
  void WidgBurRes::set_index(int ind)
{
index=ind;
}
int WidgBurRes::get_index()
{
return index;
}
void WidgBurRes::set_angle(double ang)
{
angle=ang;
}
double WidgBurRes::get_angle()
{
return angle;
}

 QRectF WidgBurRes::get_rect_eff()
{
return rect_eff;
}


 void WidgBurRes::set_text(QString str)
{
N_text=str;
cout<<"set_text"<<str.toStdString()<<endl;
update();
}
